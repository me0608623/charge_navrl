"""Run one frozen SA4-R3 continuation checkpoint-screen cell."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        f"[SA4-R3-CONT50-SCREEN] checkpoint={args.checkpoint_name} "
    ...
    cell = {
        "schema": "sa4_r3_cont50_checkpoint_screen_cell/v1",
    ...
    print(
        f"[SA4-R3-CONT50-SCREEN] {args.checkpoint_name} {args.scenario} "
