"""One-iteration GPU smoke for paper factorial cell B."""

from __future__ import annotations

from dataclasses import fields, replace

from rnn_car_modular.configs.e2e_sa1_paper_factorial_b_full_d0_p600 import (
    CONFIG as _FORMAL,
)
...
CONFIG = replace(
    _FORMAL,
    name="e2e_sa1_paper_factorial_b_full_d0_p600_smoke",
    description="64-env one-iteration GPU smoke for paper factorial cell B.",
    num_envs=64,
    timesteps=128,
    save_interval=1,
...
if _actual_diffs != EXPECTED_DIFFS:
    raise RuntimeError(f"factorial B smoke drifted: {sorted(_actual_diffs)}")
