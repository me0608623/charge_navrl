"""One-iteration GPU smoke for the B3 it100 continuation."""
...
CONFIG = replace(
    _CONT,
    name="e2e_sa5_v3_c50_stage3_b3_cont500_from_it100_smoke",
    description="64-env one-iteration smoke for the B3 it100 continuation.",
    num_envs=64,
    timesteps=128,
    save_interval=1,
