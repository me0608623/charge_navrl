"""One-iteration GPU smoke for the SA6 c250 matched control."""
...
CONFIG = replace(
    _FORMAL,
    name="e2e_sa6_v4_c250_profile_curriculum_control_p50_smoke",
    description="64-env one-iteration GPU smoke for the SA6 c250 control.",
    num_envs=64,
    timesteps=128,
    save_interval=1,
...
if _actual_diffs != EXPECTED_DIFFS:
    raise RuntimeError(f"SA6 c250 control smoke drifted: {sorted(_actual_diffs)}")
