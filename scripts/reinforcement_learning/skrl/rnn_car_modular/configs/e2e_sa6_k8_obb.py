"""SA6 entrypoint for the measured OBB collision lineage."""
...
CONFIG = replace(
    _BASE,
    name="e2e_sa6_k8_obb",
    description="K=8 + future occupancy with measured 0.70x0.60m OBB collision on SA6.",
    ...
    notes=(
        "OBB lineage warm-started from an accepted SA5 checkpoint. "
        ...
        "LiDAR noise and actuator DR remain disabled. Replay mix is 68% native SA6, "
