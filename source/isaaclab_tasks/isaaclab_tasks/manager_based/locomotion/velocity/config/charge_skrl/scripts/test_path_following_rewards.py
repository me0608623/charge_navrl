...
# 導入獎勵函數
from isaaclab_tasks.manager_based.locomotion.velocity.config.charge_skrl.mdp.rewards import (
    progress_along_path,
    cross_track_error,
...
def main():
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "Isaac-Navigation-Charge-Phase1",
            "Isaac-Navigation-Charge-Phase2",
            "Isaac-Navigation-Charge-Phase3",
        ],
        help="環境 ID（默認：Isaac-Navigation-Charge-Phase0，無障礙物）"
    )
    parser.add_argument(
        "--num-steps",
        type=int,
