...
1. 检查调试输出（运行时会打印）:
   $ python scripts/reinforcement_learning/skrl/train_charge.py --task Isaac-Navigation-Charge-Phase0 --num_envs 1
...
def main():
    ...
    print("="*70)
    print("\n建议: 运行训练脚本并查看调试输出")
    print("  python scripts/reinforcement_learning/skrl/train_charge.py \\")
