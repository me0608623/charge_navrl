...
或者直接運行（需要先啟動 Isaac Sim）:
  python source/isaaclab_tasks/isaaclab_tasks/manager_based/locomotion/velocity/config/charge/test/training_test.py --task Isaac-Navigation-Charge-Phase0 --num_envs 4 --max_iterations 10
"""
...
parser.add_argument("--task", type=str, default="Isaac-Navigation-Charge-Phase0", help="環境任務名稱")
