...
print("\n[測試 1] 導入 Phase 0 配置...")
try:
    from isaaclab_tasks.manager_based.locomotion.velocity.config.charge_skrl.cfg.charge_env_cfg_phase0 import (
...
try:
    ...
    from isaaclab_tasks.manager_based.locomotion.velocity.config.charge_skrl import __init__
...
print("  ✅ 環境已註冊")
print("\n可以使用以下命令訓練:")
print("  ./isaaclab.sh -p scripts/reinforcement_learning/skrl/train_charge.py \\")
