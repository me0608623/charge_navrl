# Charge Navigation - Stable Baselines 3 PPO 配置指南

## 📋 概述

本目錄包含使用 **Stable Baselines 3 (SB3)** 框架和 **PPO (Proximal Policy Optimization)** 算法訓練 Charge 機器人導航任務的完整配置。
...
```
charge_sb3/agents/sb3_ppo_cfg.yaml
```
...
| 版本 | 日期 | 變更 |
|------|------|------|
| v1.0 | 2025-02-04 | 初始版本，添加 SB3 PPO 配置 |
