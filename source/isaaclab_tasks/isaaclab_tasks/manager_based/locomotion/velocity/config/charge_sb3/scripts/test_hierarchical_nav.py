...
# 添加路徑
import sys
charge_sb3_path = Path(__file__).parent.parent.parent
sys.path.insert(0, str(charge_sb3_path))

from isaaclab_tasks.manager_based.locomotion.velocity.config.charge_sb3.mdp.path_planner.local_goal_extractor import (
    LocalGoalExtractor,
    LocalGoalConfig,
    extract_local_goals_batch,
)
from isaaclab_tasks.manager_based.locomotion.velocity.config.charge_sb3.mdp.observations.hierarchical_navigation import (
    local_goal_polar,
    local_goal_cartesian,
    navigation_features,
)
from isaaclab_tasks.manager_based.locomotion.velocity.config.charge_sb3.mdp.rewards.hierarchical_rewards import (
